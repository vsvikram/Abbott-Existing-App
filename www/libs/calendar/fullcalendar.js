...
var Grid = fc.Grid = RowRenderer.extend({
	...
	headCellHtml: function(cell) {
		...
		//added font class
		return '' +
			'<th class="fc-day-header ' + view.widgetHeaderClass + ' fc-' + dayIDs[date.day()] + ' fontRobotoRegular">' +
		...
		if (buttonStr) {
			$.each(buttonStr.split(' '), function(i) {
				...
				$.each(this.split(','), function(j, buttonName) {
					...
					//added font class
					if (buttonName == 'title') {
						groupChildren = groupChildren.add($('<h2 class="calendarTitle fontRobotoLight">&nbsp;</h2>')); // we always want it to take up height
						isOnlyButtons = false;
					}
					else {
...
var BasicView = View.extend({
	...
	numberCellHtml: function(cell) {
		...
		classes.unshift('fc-day-number fontRobotoLight');
