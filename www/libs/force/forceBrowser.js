...
var forceBrowser = (function () {
    ...
    // To override default, pass appId in init(props)
        appId = '3MVG9Y6d_Btp4xp6slwDJjlTur58tgT_d5Z0gaCB2FcEH4Np6ahxXpqckzbNj7.voYUzodxhcQB08exgOCJXx',
     ...
     * @param errorHandler
     */
    function query(sqlQuery, successHandler, errorHandler) {
        request(
            {
