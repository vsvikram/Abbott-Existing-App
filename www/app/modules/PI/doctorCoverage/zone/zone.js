abbottApp.controller('docCoverageZoneCtrl', ['$rootScope','$scope', '$http','$q','PIService','userDetailService','chartConfigService', 'piDocterCoverageService', function($rootScope, $scope, $http, $q, PIService, userDetailService, chartConfigService, piDocterCoverageService) {
