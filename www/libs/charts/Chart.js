...
(function(){
	...
	Chart.Type.extend({
		...
		draw : function(ease){
            ...
            //umesh- drawing label above the series in canvas
            if(this.options && this.options.seriesLabel){
                angular.forEach(this.options.seriesLabel, function(label, index){
                    ctx.fillStyle = "green";
                    ctx.textAlign = "left";
                    ctx.fillText(label.value, ctx.canvas.clientWidth*label.xaxis, ctx.canvas.clientHeight*label.yaxis);
                });
            }
		}
	});
