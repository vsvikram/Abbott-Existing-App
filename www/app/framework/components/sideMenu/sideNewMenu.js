abbottApp.directive('sidePanel', ['$rootScope', '$state', 'navigationService', 'abbottConfigService', 'menuStatus', '$timeout', 'popupService', 'databaseManager', 'dcrLockedStatusCollection', '$cordovaInAppBrowser', 'sfdcAccount',
function ($rootScope, $state, navigationService, abbottConfigService, menuStatus, $timeout, popupService, databaseManager, DcrLockedStatusCollection, $cordovaInAppBrowser, sfdcAccount) {
    ...
    var linker = function (scope, elem, attrs) {
        ...
        scope.manualMasterSync = function () {
            ...
            scope.toggleMenu();
            databaseManager.runSync($rootScope.LastSyncFail);
        ...
        scope.onLogoutIconClicked = function () {
               popupService.openConfirm('Logout', 'Are you sure you want to Logout', 'No', 'Yes', '35%', function () { },
                                function () { localStorage.setItem("isLoggedIn", false);
                                               sfdcAccount.logout();
                                            });
    ...
    return {
        ...
        link: linker,
        templateUrl: 'app/framework/components/sideMenu/sideNewMenu.html'
    };
}]);
